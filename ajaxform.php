...
$sqlquery = "INSERT INTO users(name,email,password,country_id,state_id,city_id,image) VALUES ('$name','$email','$encrypted_pwd','$countryname','$statename','$cityname','$newFileName')";
